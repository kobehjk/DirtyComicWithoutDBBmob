...
import com.blackman.ehviewer.gallery.EhGalleryProvider;
import com.blackman.ehviewer.gallery.ZipGalleryProvider;
import com.blackman.ehviewer.widget.ReversibleSeekBar;
...
import com.blackman.ehviewer.gallery.DirGalleryProvider;
import com.blackman.ehviewer.gallery.GalleryProvider2;
import com.blackman.ehviewer.widget.GalleryGuideView;
...
import com.blackman.util.SystemUiHelper;
import com.blackman.widget.ColorView;
...
//        SimpleHandler.getInstance().post(task);
    ...
    private void shareImage(int page) {
        ...
        Uri uri = new Uri.Builder()
                ...
                .authority("com.blackman.ehviewer.fileprovider")
                .appendPath("image")
                .appendPath(filename)
                .build();
